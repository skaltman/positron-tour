...
Positron Assistant is an **AI tool that provides LLM integration within Positron.** Use it to generate code, debug, or get suggestions for next steps. Positron Assistant can access context from the Console, Variables pane, and Plots pane, and you can also manually attach files to give it additional context.
